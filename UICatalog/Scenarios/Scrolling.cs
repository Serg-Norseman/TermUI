...
namespace UICatalog.Scenarios {
	...
	public class Scrolling : Scenario {
		...
		public override void Setup ()
		{
			...
			pressMeButton.Clicked += (sender, e) => MessageBox.Query (20, 7, "MessageBox", "Neat?", "Yes", "No");
			...
			aLongButton.Clicked += (sender, e) => MessageBox.Query (20, 7, "MessageBox", "Neat?", "Yes", "No");
