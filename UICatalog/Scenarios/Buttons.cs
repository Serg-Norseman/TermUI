...
namespace UICatalog.Scenarios {
	...
	public class Buttons : Scenario {
		public override void Setup ()
		{
			...
			defaultButton.Clicked += (sender, e) => Application.RequestStop ();
			Win.Add (defaultButton);

			var swapButton = new Button (50, 0, "Swap Default (Absolute Layout)");
			swapButton.Clicked += (sender, e) => {
			...
			button.Clicked += (sender, e) => MessageBox.Query ("Message", "Question?", "Yes", "No");
			...
			Win.Add (textChanger);
			textChanger.Clicked += (sender, e) => textChanger.Text += "!";
			...
			moveHotKeyBtn.Clicked += (sender, e) => {
			...
			moveUnicodeHotKeyBtn.Clicked += (sender, e) => {
