...
namespace UICatalog.Scenarios {
	...
	public class Threading : Scenario {
		...
		public override void Setup ()
		{
			...
			_btnActionCancel.Clicked += (sender, e) => Application.MainLoop.Invoke (CallLoadItemsAsync);
			...
			_btnAction.Clicked += (sender, e) => _action.Invoke ();
			...
			_btnMethod.Clicked += async (sender, e) => await MethodAsync ();
			var _btnClearData = new Button (80, 20, "Clear Data");
			_btnClearData.Clicked += (sender, e) => { _itemsList.Source = null; LogJob ("Cleaning Data"); };
			var _btnQuit = new Button (80, 22, "Quit");
			_btnQuit.Clicked += (sender, e) => Application.RequestStop ();
