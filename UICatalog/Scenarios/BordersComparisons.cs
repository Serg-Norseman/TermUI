...
namespace UICatalog.Scenarios {
	...
	public class BordersComparisons : Scenario {
		public override void Init (ColorScheme colorScheme)
		{
			...
			button.Clicked += (sender, e) => MessageBox.Query (20, 7, "Hi", "I'm a Window?", "Yes", "No");
			...
			button2.Clicked += (sender, e) => MessageBox.Query (20, 7, "Hi", "I'm a Toplevel?", "Yes", "No");
			...
			button3.Clicked += (sender, e) => MessageBox.Query (20, 7, "Hi", "I'm a FrameView?", "Yes", "No");
